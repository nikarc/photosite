...
export type ImageFragmentFragment = { __typename?: 'Image', tag: Array<ImageTag>, file?: { __typename?: 'Asset', url: string, description?: string | null } | null } & { ' $fragmentName'?: 'ImageFragmentFragment' };
